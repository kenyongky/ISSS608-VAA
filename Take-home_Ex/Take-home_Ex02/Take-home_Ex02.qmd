...
```{r}
pacman::p_load(ggrepel, readxl, data.table, tidyverse, plotly, ggthemes, patchwork, scales, tsibble, lubridate, feasts)
```
...
# Visualisation 2: Merchandise Trade Performance with Major Trading Partners (2024)
